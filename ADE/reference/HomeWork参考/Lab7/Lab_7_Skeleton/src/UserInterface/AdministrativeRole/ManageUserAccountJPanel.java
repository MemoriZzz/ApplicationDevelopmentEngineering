...
public void populateEmployee(Organization o)
{
    if(o!=null)
    {
    ...
    {
        JOptionPane.showMessageDialog(null,"No Organization selected","Error",JOptionPane.ERROR_MESSAGE);
    }
}
public void populateRole(Organization e)
{
    if(e!=null)
    {
        roleJComboBox.removeAllItems();
        for(Role r : e.getEmployeeRole())
        {
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        populateEmployee(o);
        JOptionPane.showMessageDialog(null,"User Account created successfully","Success",1);
