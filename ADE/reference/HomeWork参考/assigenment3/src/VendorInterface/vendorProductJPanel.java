 ...
 * @author yyneu
 */
public class vendorProductJPanel extends javax.swing.JPanel {
   ...
   private Product product;
    public vendorProductJPanel(JPanel userProcessContainer, Product product) {
       initComponents();
       initComponents();
    ...
    ArrayList<String> list = new ArrayList<String>();
        ...
        product.setProductCatalog(txtProductCatalog.getText());
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        txtProductCatalog.setEnabled(true);
