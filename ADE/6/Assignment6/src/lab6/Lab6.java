...
public class Lab6 {
    ...
    private void runAnalysis(){
     ...
     /*   helper.userWithMostLikes();
        ...
        helper.findAverageLikePerComment();
        
        helper.findThePostWithMostLikedComment();
        
        helper.findThePostWithMostComment();
        
        helper.getFiveLessComment();
        
        helper.getFiveLessPost();
        helper.getFiveLessLikes();*/
        
        helper.getFiveLessAll();
    }
}
