...
public class AdminCreateScreen extends javax.swing.JPanel {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(81, 81, 81)
                                .addComponent(emailErrorField, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE))
  ...
  if(txtUser.getText().isEmpty() && txtPword.getText().isEmpty() && txtRePword.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "please enter all manadatory fields");
        }
        else{
    ...
    if(txtUser.getText().isEmpty() && txtPword.getText().isEmpty() && txtRePword.getText().isEmpty()){
            ...
            if(radioCustomer.isSelected()){
               ...
               if(txtPword.getText().equals(txtRePword.getText())){
                   ...
                   admin.getCustDir().addCustomer(password, username);
