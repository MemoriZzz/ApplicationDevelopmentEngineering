...
public class AdminCreateScreen extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        emailErrorField.setBackground(new java.awt.Color(153, 153, 153));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(68, 68, 68)
                                .addComponent(emailErrorField, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(emailErrorField, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if(txtUser.getText().isEmpty()&&txtPword.getText().isEmpty()&&txtRePword.getText().isEmpty()){
            JOptionPane.showMessageDialog(null,"please enterall manadatory field");
        }else{
            if(radioSupplier.isSelected()){
                ...
                if(txtPword.getText().equals(txtRePword.getText())){
                    ...
                    admin.getSuppDir().addSupplier(password, username);
                    
                    JOptionPane.showMessageDialog(null,"supplier created successfully");
                }
                else if(!isValidPass){
                    JOptionPane.showMessageDialog(null,"pass and conf pass don't match");
                }
    ...
    private void txtUserFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtUserFocusLost
        ...
        if(matcher.matches()){
            ...
            emailErrorField.setText("emailID with _ and @ only");
        }
